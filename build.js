...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Increment = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] components\\Display.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-6c276822/Display.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] components\\Increment.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-f5f6e248/Increment.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	//         <button @click="reduce">Increment -1</button>
	//     </div>
	// </template>
	//
	// <script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = {
	    ...
	    // 你可以在函数里修改 state
	    INCREMENT: function INCREMENT(state, amout) {
	        state.count = state.count + amout;
	    },


	    //减1
	    REDUCE: function REDUCE(state, amout) {
	        state.count = state.count - amout;
	    }
	};
